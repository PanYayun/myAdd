<template>
  ...
  <div class="layout_container" style="display: flex">
    <div
      style="width: 290px; height: 104px; display: flex; align-items: center"
    >
      <img
        @click="gotoHome"
    ...
    <div style="height: 104px; display: flex; align-items: center">
      <Input class="search_input" v-model="Input_seach_data_1" />
      <Button
        style="
