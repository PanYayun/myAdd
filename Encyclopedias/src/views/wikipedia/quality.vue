  ...
  <div class="main_container">
    <div class="flex">
      ...
      <div class="right_module">
        <div class="info_picture_wrap">
          <Carousel v-model="carouselValue" loop>
            <CarouselItem v-for="(item,index) in rotate_Pictures_urls" :key="index">
              <div>
                <img style="width:300px;height:187px"
                  :src="item"
                />
              </div>
            </CarouselItem>
        ...
        <div
          class="termExplain margin_tp"
          v-if="search_term2.data.length > 0"
        >
          <ul class="list_nav_ul flex">
        ...
        <div
          class="termExplain margin_tp"
          v-if="search_term3.data.length > 0"
        >
          <ul class="list_nav_ul flex">
  ...
  methods: {
      ...
      if (Plane_Type == "JJ") {
        this.search_term = {
          ...
          data: [
            ...
            { title: "直XX", description: "浏览次数" },
            { title: "直XY", description: "浏览次数" },
          ],
        };
        this.search_term2 = {
          header: "热门故障排行",
          ...
          this.search_term3 = { data: [] };
      } else if (Plane_Type == "MJ") {
        this.search_term = {
          header: "飞机型号热门",
          data: [
            { title: "C919", description: "浏览次数" },
            { title: "B737", description: "浏览次数" },
            { title: "A320", description: "浏览次数" },
            { title: "A350", description: "浏览次数" },
            { title: "B787", description: "浏览次数" },
            { title: "ARJ21", description: "浏览次数" },
          ],
        };
        this.search_term2 = {
          header: "航空安全事故热门",
          data: [
            { title: "机体故障", description: "浏览次数" },
            { title: "IMC中的VFR飞行", description: "浏览次数" },
            { title: "重着陆", description: "浏览次数" },
            { title: "机上起火", description: "浏览次数" },
            { title: "雷击", description: "浏览次数" },
            { title: "与鸟类和物体的碰撞", description: "浏览次数" },
          ],
        };
        this.search_term3 = {
          header: "维修保养运营热门",
          data: [
            { title: "起落架", description: "浏览次数" },
            { title: "燃油系统", description: "浏览次数" },
            { title: "发动机类：70-91章", description: "浏览次数" },
            { title: "叶片", description: "浏览次数" },
            { title: "滑油泵", description: "浏览次数" },
            { title: "防火系统", description: "浏览次数" },
          ],
        };
      } else {
        this.search_term = { data: [] };
        this.search_term2 = { data: [] };
        this.search_term3 = { data: [] };
      }
    },
    threeFold() {},
    ...
    ProcessingData() {
      ...
      this.rotate_Pictures_urls = this.qualityData.Rotate_Pictures_urls;
        ...
        this.rotate_Pictures_urls = ["http://n.sinaimg.cn/sinakd2021626s/581/w850h531/20210626/3a11-krwipar6835151.jpg"]
      }
