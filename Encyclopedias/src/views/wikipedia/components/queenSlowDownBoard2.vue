            ...
            <div class="unique_wrap padding_0">
              ...
              <div>
                ...
                >
                  ...
                  >
                    <Select
                      v-model="faultList.table_form_1.selectgzType"
                      placeholder="原因分类"
                      style="width: 130px"
                    >
                      <Option
                        v-for="item in faultList.gztypeList"
                        :value="item.value"
                        :key="item.value"
                        >{{ item.label }}</Option
                      >
...
export default {
  name: "queenSlowDownBoard2",
  props: ["detailData", "rightImgText"],
  components: {
    collapse,
    failureRecordModel,
    collection,
    ...
    requestGuzhangDetailData() {
      this.$axios("/baike/appServer/requestGetData", "get", {
        ...
        requestParams: {
          ...
          sgxzfl:
            this.faultList.table_form_1.selectType == "0"
              ? ""
              : this.faultList.table_form_1.selectType,
          sgyyfl:
            this.faultList.table_form_1.selectgzType == "0"
              ? ""
              : this.faultList.table_form_1.selectgzType,
        },
      }).then((res) => {
