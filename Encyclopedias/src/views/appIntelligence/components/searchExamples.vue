<template>
  <div>
    ...
    <div v-if="search_other.data != ''" class="list list_em">
      <div
        class="item"
      ...
      >
        <Tooltip max-width="350" :content="item.title" theme="light">
          <div class="title text_hidden_1" v-html="item.title"></div>
        </Tooltip>
        <div class="info flex">
          ...
          <div class="flex text_info">
            ...
            <span class="reason" style="font-size: 12px"
              >推荐理由:{{ item.data_type }}</span
            >
          </div>
        </div>
      </div>
