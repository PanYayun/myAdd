<template>
    <div>
        ...
        <div v-if="search_standard.data!=''" class="list">
            <div class="item flex item2" @click="gotoPage(item)" v-for="(item, index) in search_standard.data" :key="index">
