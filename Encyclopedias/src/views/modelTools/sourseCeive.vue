            ...
            <Form :model="formVal" :label-width="98" ref="formVal" :rules="ruleFormVal">
                ...
                <FormItem label="" prop="exactContents">
                    <!-- <Input v-model="exactcontent" type="textarea" style="resize: none;" :autosize="{minRows: 3,maxRows: 5}" placeholder="请输入备注"></Input>
                     -->
                     <div style="margin-left:-98px">知识元抽取结果：       图例：<span style="color:white;background-color:green;font-weight:bold;">实体</span>  <span style="color:white;background-color:red;font-weight:bold;">属性名称</span>  <span style="color:white;background-color:blue;font-weight:bold;">属性值</span>  <span style="color:white;background-color:brown;font-weight:bold;">约束条件</span></div> 
                     <div style="padding-bottom:30px;margin-top:20px;width:100%;display:block;min-height:120px;max-height:500px;overflow-y:auto;">
          ...
          axios.post('/knowledge', param, config).then(res => {
            ...
            if (res.status == 200) {
              ...
              for (var i=0;i<this.tableData.length;i++){
                this.tableData[i].sentence = this.tableData[i].sentence.replace(this.tableData[i].object,'<el-button style="color:white;background-color:green;font-weight:bold">' + this.tableData[i].object + '</el-button>')
                this.tableData[i].sentence = this.tableData[i].sentence.replace(this.tableData[i].relation,'<el-button style="color:white;background-color:red;font-weight:bold">' + this.tableData[i].relation + '</el-button>')
                this.tableData[i].sentence = this.tableData[i].sentence.replace(this.tableData[i].subject,'<el-button style="color:white;background-color:blue;font-weight:bold">' + this.tableData[i].subject + '</el-button>')
                this.tableData[i].sentence = this.tableData[i].sentence.replace(this.tableData[i].condition,'<span style="color:white;background-color:brown;font-weight:bold">' + this.tableData[i].condition + '</span>')
