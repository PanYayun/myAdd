...
export default {
  ...
  methods: {
    ...
    handleScroll() {
      ...
      let hearTop = $(".cont_maxTop").offset().top; //滚动条头部开始的地方
      let hearTop1 = $(".item1").offset().top - 50;
      let hearTop2 = $(".item2").offset().top - 50;
      let hearTop3 = $(".item3").offset().top - 50;
