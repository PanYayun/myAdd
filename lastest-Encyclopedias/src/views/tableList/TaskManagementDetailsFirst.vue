          ...
          ">
                <div style="width: 100%;display:flex">
                    <div :class="[TaskFlow == 1 ? 'activele' : '', 'Taskschedule']">
                        <div class="iconlis">
                            <img v-show="TaskFlow == 1" src="@/img/knowledge/AfterKnowledge.png" alt="" />
                            <img v-show="TaskFlow !== 1" src="@/img/knowledge/PreKnowledge.png" alt="" />
                        </div>
                        <p>通用知识加工</p>
                        ...
                        <div class="back">
                            <div></div>
                            <div>
                                <img v-show="TaskFlow == 1" src="@/img/knowledge/done.png" alt="" />
                                <img v-show="TaskFlow !== 1" src="@/img/knowledge/Unchecked.png" alt="" />
                            </div>
                    ...
                    <div :class="[TaskFlow == 2 ? 'activele' : '', 'Taskschedule']">
                        <div class="iconlis">
                            <img v-show="TaskFlow == 2" src="@/img/knowledge/AfterMajor.png" alt="" />
                            <img v-show="TaskFlow !== 2" src="@/img/knowledge/PreProfessional.png" alt="" />
                        </div>
                        <p>专业知识抽取</p>
                        ...
                        <div class="back">
                            <div></div>
                            <div>
                                <img v-show="TaskFlow == 2" src="@/img/knowledge/done.png" alt="" />
                                <img v-show="TaskFlow !== 2" src="@/img/knowledge/Unchecked.png" alt="" />
                            </div>
                            <div></div>
                        </div>
                    </div>
                    <div :class="[TaskFlow == 3 ? 'activele' : '', 'Taskschedule']">
                        <div class="iconlis">
                            <img v-show="TaskFlow == 3" src="@/img/knowledge/AfterAudit.png" alt="" />
                            <img v-show="TaskFlow !== 3" src="@/img/knowledge/BeforeAudit.png" alt="" />
                        </div>
                        <p>知识审核</p>
                        ...
                        <div class="back">
                            <div></div>
                            <div>
                                <img v-show="TaskFlow == 3" src="@/img/knowledge/done.png" alt="" />
                                <img v-show="TaskFlow !== 3" src="@/img/knowledge/Unchecked.png" alt="" />
                            </div>
                            <div></div>
                        </div>
                    </div>
                    <div :class="[TaskFlow == 4 ? 'activele' : '', 'Taskschedule']">
                        <div class="iconlis">
                            <img v-show="TaskFlow == 4" src="@/img/knowledge/AfterData.png" alt="" />
                            <img v-show="TaskFlow !== 4" src="@/img/knowledge/BeforeData.png" alt="" />
                        </div>
                        <p>数据入库</p>
                        ...
                        <div class="back">
                            <div></div>
                            <div>
                                <img v-show="TaskFlow == 4" src="@/img/knowledge/done.png" alt="" />
                                <img v-show="TaskFlow !== 4" src="@/img/knowledge/Unchecked.png" alt="" />
                            </div>
                            <div></div>
                        </div>
                    </div>
            ...
            <!-- 表格 -->
            <!-- border -->
            <Table border stripe height="522" highlight-row :data="tableData_1" :loading="loading_1" :columns="tableColumns_1"></Table>
            <Row>
                <Col span="24" style="text-align: center;padding-bottom:50px; margin-top: 30px">
                <Button type="primary" @click="Next_step()" style="width: 100px">下一步</Button>
                </Col>
            </Row>
        </Card>
        <Modal v-model="modal1" width="800" :mask-closable="false" scrollable inline class="modal1_log_1" @on-visible-change="Modal_status">
