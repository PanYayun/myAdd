...
export default {
  ...
  methods: {
    ...
    //测试ID "test_subjob_id_4444" 'bbiaozhun-subtest-00007'
    Initialize() {
      let thats = this.StandardKnowledge
        ? '/baike/yuchuli/biaozhun/check_jituan_class'
        : '/baike/yuchuli/shigu/check_accident_reason';
      this.$Spin.show();
      ...
      this.$axios(
        ...
        console.log(
          res,
          this.StandardKnowledge ? '标准按832自动分类' : '事故原因分类'
        );
    ...
    preservation() {
      let thats = this.StandardKnowledge
        ? '/baike/yuchuli/biaozhun/save_jituan_class'
        : '/baike/yuchuli/shigu/save_accident_reason';
      ...
      this.$axios(
        ...
        console.log(
          res,
          this.StandardKnowledge ? '标准按832自动分类保存成功' : '保存成功'
        );
      });
    },
    //返回
