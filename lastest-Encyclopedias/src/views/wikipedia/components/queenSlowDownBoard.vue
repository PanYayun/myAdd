<template>
  <div class="flex">
    <div class="left_module">
      ...
      >
        ...
        <div
          ...
          v-html="changeHtml(subDetailData.topContent.Text_Content)"
        ></div>
        <!-- <div class="btm_wrap">
      ...
      >
        ...
        >
              ...
              <collapse>
                <div style="overflow: hidden;" v-show="item2.isOpen">
                  <div
                    class="text"
                    style="text-indent: 0px;"
                    v-html="changeHtml(item2.Text_Content)"
                  ></div>
                </div>
              </collapse>
            </div>
          ...
          <div
            class="ifififi"
            v-if="item2.Text_Type == 'text' || item2.Text_Type == 'Text&text'"
          >
            <div class="unique_wrap padding_0">
              <div class="unique_title_text flex" style="margin-bottom: 17px;">
                <span>{{ item2.Text_title }}</span>
            ...
            <div class="unique_wrap padding_0">
              ...
              <div>
                <Form
                  inline
                  ref="table_form_1"
                  :rules="faultList.form_rules_1"
                  :model="faultList.table_form_1"
                  label-position="left"
                >
                  <FormItem
                    label="起至时间"
                  ...
                  >
                    <DatePicker
                      v-model="faultList.table_form_1.selectTime"
                      type="daterange"
                  ...
                  >
                    <Select
                      v-model="faultList.table_form_1.selectType"
                      placeholder="请选择类型"
                      style="width: 100px"
                    >
                      <Option
                        v-for="item in faultList.typeList"
                        :value="item.value"
                        :key="item.value"
                        >{{ item.label }}</Option
                      >
                  ...
                  <Button
                    @click="resetData(faultList.table_form_1)"
              ...
              <Row v-if="spin_search_Page_box">
                <Col span="24">
                  <div
                    style="padding-top: 15px;display: flex;justify-content: center;align-items: center;"
                  >
                    <div>
    ...
    <failure-record-model
      ...
      ref="failureRecord"
    ></failure-record-model>
    <failure-record-model-private
      v-else
      :failureRecord="table_current_item"
      :rightImgText3="rightImgText3"
      ref="failureRecord"
    ></failure-record-model-private>
  </div>
</template>
