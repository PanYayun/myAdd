...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/standard/lixiangQuery",
        name: "lixiangQuery",
        meta: {
          title: "立项查新",
          
        },
        component: () => import("@/views/standardModule/lixiangQuery"),
      },
      {
      ...
      {
        path: "/standard/stardardPersonSys",
        name: "stardardPersonSys",
        meta: {
          title: "体系维护",
        },
        component: () => import("@/views/standardModule/stardardPersonSys"),
      },
