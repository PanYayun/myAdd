<template>
    <div class="ivu-select ivu-select-default" >
        <div tabindex="0" class="ivu-select-selection ivu-form-item-content" >
            <div @mouseover="mouseover" @mouseleave="mouseleave" :class="disabled==false?'':'cursorNoDrop'">
                <div  @click="clickInputShow" >
                    ...
                    <span v-if="multipleHideVal && multipleHideVal.length === 0 && multiple " class="ivu-select-placeholder" style="">请选择</span>
                    <span v-if="value === '' && !multiple && !queryVal " class="ivu-select-placeholder" style="">请选择</span>
            ...
            <div v-show="showTree" class="ivu-select-dropdown"
                 style="max-height: 320px;z-index:99;width:100%;display: flex;flex-direction: column;">
                <div class="data_wrap" style="overflow: auto;flex: 1;">
...
<!--                <div class="btn_module" style="display: flex;align-items: center;justify-content: center;" v-show="showTree">-->
<!--                    <Button type="primary" style="margin-right: 7px;" @click="ok">确认</Button>-->
<!--                    <Button style="margin-left: 7px;" @click="cancel">关闭</Button>-->
<!--                </div>-->
            </div>
        </div>
    </div>
